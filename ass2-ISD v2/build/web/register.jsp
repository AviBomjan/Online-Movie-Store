    ...
    <body onload="startTime()">
        ...
        <form action="registerAction.jsp" method="post">
            <table>
                ...
                <tr><td>Password:</td><td><input size="30" type="password" name="password" value="<%=(passError != null ? passError : "")%>"></td></tr>
                 <tr><td>Phone:</td><td><input size="30" type="text" name="phone"></td></tr>
                <tr><td>Date of Birth:</td><td><input size="30" name="dob"></td></tr>
                <tr><td>Role:</td><td><input size="30" type="text" name="role">Customer Or Manager</td></tr>
