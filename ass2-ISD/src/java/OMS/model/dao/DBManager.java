...
public class DBManager {
    ...
    public User findCustomer(String ID, String password) throws SQLException {
        ...
        if (more) {
            ...
            User customer = new User(id, email, name, password,phone, dob);
            return customer;
    ...
    public void Register(String ID, String email, String name, String password, String phone, String dob) throws SQLException {
        st.executeUpdate("INSERT INTO OMS.Customers VALUES ('" + ID + "','" + email + "','" + name + "','" + password + "','"+phone+"','" + dob + "')"); //code for add-operation
    }
